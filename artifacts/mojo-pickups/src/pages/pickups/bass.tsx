...
const products = getCategoryProducts("bass");
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <motion.div initial="hidden" animate="visible" className="max-w-3xl">
            <motion.p custom={0} variants={fadeUp} className="text-gold uppercase tracking-widest text-xs font-medium mb-4 flex items-center gap-3">
              <span className="inline-block w-6 h-px bg-gold" />Bass Pickups
            </motion.p>
            ...
            <motion.p custom={2} variants={fadeUp} className="text-xl text-muted-foreground leading-relaxed max-w-xl">
              Pre-CBS Precision and Jazz Bass pickups wound to vintage Fender specification. The foundation of recorded bass — from Motown to punk, that round, punchy fundamental that sits in every great track.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          <ProductGrid products={products} category="bass" />
        </div>
      </section>
      ...
      <section className="py-12 bg-card border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-serif text-xl font-semibold">Not sure which bass pickup era suits you?</p>
            <p className="text-muted-foreground text-sm mt-1">Email Marc and describe your bass and the sound you're chasing. He'll advise directly.</p>
          </div>
