...
const pickups = [
  {
    name: "Dynasonic Single Coil",
    priceRange: "From £110",
    tagline: "The original DeArmond Dynasonic voicing — bright, percussive, and utterly distinctive.",
    details: [
      "Alnico blade magnets",
      "DeArmond Dynasonic specification",
      "Gretsch-compatible dimensions",
      "Bright, cutting treble response",
      "UK-wound in Ripponden",
    ],
    voicing: "The Dynasonic is one of the most distinctive sounding pickups in existence. Alnico blade magnets sitting very close to the strings produce a bright, almost glassy sound with enormous presence and a fast, percussive attack. Used in Gretsch guitars from the early 50s — the defining tone of rockabilly and early rock and roll.",
    featured: true,
  },
  {
    name: "HB Dynasonic (Humbucker Sized)",
    priceRange: "From £130",
    tagline: "Dynasonic character in a humbucker-sized housing — for guitars with HB routing.",
    details: [
      "Humbucker-sized mounting",
      "Dynasonic-style voicing",
      "Alnico blade magnets",
      "Drop-in replacement for HB routed guitars",
      "Cover options available",
    ],
    voicing: "All the chimey, percussive Dynasonic character — but in a package that fits standard humbucker routing. No re-routing, no adapters, no compromise. If you want that Gretsch character in a guitar that wasn't designed for it, this is the answer.",
  },
];
...
export default function DynasPickups() {
  return (
    <div>
      <section className="py-28 md:py-36 bg-card border-b border-white/5" data-testid="section-dynas-header">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <motion.div initial="hidden" animate="visible" className="max-w-3xl">
            ...
            <motion.p custom={2} variants={fadeUp} className="text-xl text-muted-foreground leading-relaxed max-w-xl">
              DeArmond Dynasonic and HB-style Gretsch pickups — percussive, chimey, and completely unlike any other pickup in existence. Wound in Ripponden to vintage specification.
            </motion.p>
          </motion.div>
        </div>
      </section>

      <section className="py-16" data-testid="section-dynas-pickups">
        <div className="container mx-auto px-4 md:px-6">
      ...
      <section className="py-12 bg-card border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-serif text-xl font-semibold">Not sure which Dyna fits your guitar?</p>
            <p className="text-muted-foreground text-sm mt-1">Marc can advise on dimensions, height and mounting for your specific instrument.</p>
          </div>
