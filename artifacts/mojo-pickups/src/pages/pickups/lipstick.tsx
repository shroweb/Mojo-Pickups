...
const pickups = [
  {
    name: "Lipstick Tube Single Coil",
    priceRange: "From £85",
    tagline: "The Danelectro-style lipstick tube pickup — glassy, ethereal, and unlike anything else.",
    details: [
      "Lipstick chrome tube housing",
      "Single coil",
      "Alnico rod magnet",
      "Danelectro voicing",
      "Various spacings available",
      "UK-wound in Ripponden",
    ],
    voicing: "The lipstick pickup is named for the chrome tube housing repurposed from actual lipstick tubes in the early Danelectro designs. It produces a sound that's uniquely glassy and ethereal — not as bright as a Strat, not as warm as a P90, but something entirely its own. Beloved by everyone from Jimmy Page to Kurt Cobain for its airy, slightly hollowed tone.",
    featured: true,
  },
];

export default function LipstickPickups() {
  return (
    <div>
      <section className="py-28 md:py-36 bg-card border-b border-white/5" data-testid="section-lipstick-header">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <motion.div initial="hidden" animate="visible" className="max-w-3xl">
            ...
            <motion.p custom={2} variants={fadeUp} className="text-xl text-muted-foreground leading-relaxed max-w-xl">
              Danelectro-style lipstick tube pickups. Glassy, ethereal, and completely unique — the sound you can't get from anything else.
            </motion.p>
          </motion.div>
        </div>
      </section>

      <section className="py-16" data-testid="section-lipstick-pickups">
        <div className="container mx-auto px-4 md:px-6">
      ...
      <section className="py-12 bg-card border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-serif text-xl font-semibold">Questions about Lipstick pickups?</p>
            <p className="text-muted-foreground text-sm mt-1">Marc can advise on sizing and mounting for your guitar.</p>
          </div>
