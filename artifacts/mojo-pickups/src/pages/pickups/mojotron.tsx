...
const products = getCategoryProducts("mojotron");
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <motion.div initial="hidden" animate="visible" className="max-w-3xl">
            <motion.p custom={0} variants={fadeUp} className="text-gold uppercase tracking-widest text-xs font-medium mb-4 flex items-center gap-3">
              <span className="inline-block w-6 h-px bg-gold" />Mojotron Pickups
            </motion.p>
            ...
            <motion.p custom={2} variants={fadeUp} className="text-xl text-muted-foreground leading-relaxed max-w-xl">
              Mojo's FilterTron-style humbucker — the jangly, percussive twang of rockabilly and early rock and roll. Clean and chimey on a clean amp, snarling when you push it.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          <ProductGrid products={products} category="mojotron" />
        </div>
      </section>
      ...
      <section className="py-12 bg-card border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-serif text-xl font-semibold">Compatible with your Gretsch or archtop?</p>
            <p className="text-muted-foreground text-sm mt-1">Email Marc with your guitar model and he'll confirm fit and wiring options.</p>
          </div>
